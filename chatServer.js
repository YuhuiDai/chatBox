...
/// These are the main statments that make up the conversation.
  if (questionNum == 0) {
    ...
    if (input.toLowerCase()==='yes'|| input===1){
      ...
      question = 'Who is your favorite character?';
        ...
        answer='We live in different universe, Bye';
        question='';
        waitTime =0;
    } else{
  ...
  // load next question
    ...
    character = input;
    answer= ' Cool! ' + input+' is also my favorite character';
    waitTime = 2000;
    question = 'Where do you want to travel with '+ input +' to?';			    	// load next question
  } else if (questionNum == 3) {
    place = input;
    answer= 'Having arrive at ' + input;
    waitTime = 2000;
    question = 'What food do you want to eat?' ;			    	// load next question
  } else if (questionNum == 4) {
    answer= 'Enjoy your ' + input + ' with '+ character + ' in ' + place;
    waitTime =0;
    question = '';
  } else {
